<?php
    ...
    $hasil = $proses->tampil_data_id('tbl_demi','id_demi',$idGet);
?>

<!DOCTYPE HTML>
<html>
	<head>
		<title>Edit Demisioner</title>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<div class="card">
						...
						<h4 class="card-title">Edit Demisioner <?php echo $hasil['nama'];?></h4>
						</div>
						<div class="card-body">
						<!-- form berfungsi mengirimkan data input 
						dengan method post ke proses crud dengan paramater get aksi edit -->
							<form action="proses/crud_demi.php?aksi=edit" method="POST">
								...
								<div class="form-group">
									...
									<textarea type="number" name="tanggal_lahir" class="form-control"><?php echo $hasil['tanggal_lahir'];?></textarea>
								</div>
								<div class="form-group">
